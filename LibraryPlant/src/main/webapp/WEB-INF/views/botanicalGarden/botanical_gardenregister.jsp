			...
			<form action="${contextPath}/botanicalgarden/register" method="post">
				...
				<div class="form-group">
					<label>위도</label> <input type="number" class="form-control"
						placeholder="식물원 또는 수목원 위도" name="g_latitude" id="g_latitude" step="any" readonly="readonly">
				</div>
				<div class="form-group">
					<label>경도</label> <input type="number" class="form-control"
						placeholder="식물원 또는 수목원 경도" name="g_longitude" id="g_longitude" step="any" readonly="readonly">
				</div>
