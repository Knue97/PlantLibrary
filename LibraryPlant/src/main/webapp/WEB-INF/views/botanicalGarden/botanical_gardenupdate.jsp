			...
			<form action="${contextPath}/botanicalgarden/register" method="post">
				...
				<div class="form-group">
					<label>주소</label> <input type="text" class="form-control"
						...
						id="address_kakao" value="${VO.g_detailedAddress }">
				...
				<div class="form-group">
					<label>위도</label> <input type="number" class="form-control"
						placeholder="식물원 또는 수목원 위도" name="g_latitude" id="g_latitude" step="any" readonly="readonly" value="${VO.g_latitude }">				</div>
				<div class="form-group">
					<label>경도</label> <input type="number" class="form-control"
						placeholder="식물원 또는 수목원 경도" name="g_longitude" id="g_longitude" step="any" readonly="readonly" value="${VO.g_longitude }">
				</div>
				<button type="submit" onclick="add();">수정</button>
...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=0397e862e5ddaaeacf218bf8ffddaa4e&libraries=services"></script>
<script>
            ...
            oncomplete: function(data) {
                ...
                geocoder.addressSearch(data.address, function(results, status) {
                    ...
                    if (status === daum.maps.services.Status.OK) {
                        ...
                        //좌표값을 입력한다.
                        document.getElementById("g_latitude").setAttribute("value",result.y);
                        document.getElementById("g_longitude").setAttribute("value",result.x);
                        // 지도를 보여준다.
