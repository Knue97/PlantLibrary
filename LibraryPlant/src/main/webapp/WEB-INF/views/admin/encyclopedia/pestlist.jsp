				...
				<div class="form-group col-md-6" style="float: right;">
				     <div class="form-group">
				      <div class="input-group mb-3">
				       <input id="searchword" style="height: 45px;" type="text" class="form-control" placeholder="해충 이름을 검색하세요">
...
<script>
	...
	function search(){
		...
		var htmls = '';
			...
			$.ajax({
				url: "${contextPath}/admin/search/pest",
				data: {
				...
				success: function(result){
					...
					for(var i=0; i<result.length; i++){						
						...
						htmls += '<tr><td><a href="${contextPath }/encyclopedia/pest/detail?pe_id='+ result[i].pe_id +'">'+ result[i].pe_id +'</a></td>';
						htmls += '<td><a href="${contextPath }/encyclopedia/pest/detail?pe_id='+ result[i].pe_id +'">'+ result[i].pe_name +'</a></td>';
						htmls += '<td class="text-center"><a href="${contextPath }/admin/encyclopedia/pest/update?pe_id='+ result[i].pe_id +'">수정</a></td>';
						htmls += '<td class="text-center"><a onclick="delConfirm('+ result[i].pe_id +');">삭제</a></td></tr>';
	...
	function reload(){
		location.href = "${contextPath}/admin/encyclopedia/pest?num=1";
	}
</script>
</body>
</html>