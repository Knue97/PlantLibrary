                        ...
                        <div class="row align-items-center justify-content-center">
                            <div class="col-xl-5 col-lg-5 col-md-9 ">
                                <div class="hero__caption text-center">
                                    <span data-animation="fadeInDown" data-delay=".3s">Show My Plants</span>
                                    <h1 data-animation="fadeInDown" data-delay=".1s ">자랑 게시판</h1>
	        ...
	        <section class="content container-fluid">
				...
				<div>
					...
					<table class="table">
						...
						<c:forEach var="board" items="${showListAll }">
							<tr>
								<td>${board.b_no}</td>
						...
						<div class="block-27">
							<ul class="blog-pagination">
								<c:if test="${pageMaker.prev}">
									<li>
										<a href='<c:url value="/board/showListAll?page=${pageMaker.startPage - 1}"/>'>
											<i class="fa fa-chevron-left"></i>
										</a>
									</li>
								</c:if>
								<c:forEach begin="${pageMaker.startPage}" end="${pageMaker.endPage}" var="pageNum">
									<li><a href='<c:url value="/board/showListAll?page=${pageNum}"/>'>
								...
								<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
									<li>
										<a href='<c:url value="/board/showListAll?page=${pageMaker.endPage + 1}"/>'>
